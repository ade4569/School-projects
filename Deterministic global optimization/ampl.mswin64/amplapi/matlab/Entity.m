classdef Entity < handle
    ...
    methods
        ...
        function isValid = isValid(self)
           isValid = self.impl.isValid();
        end
        ...
        function data = getValues(self, varargin)
            ...
            %   See also DataFrame
            if ~self.isValid()
                error('Invalid operation: Object state is not valid.');
            end
            try
                if(nargin > 1)
