...
class Entity {
 public:
  ...
  /**
  * Returns true if the entity is in a valid state. That is, if the underlying 
  * intepreter is still open and the related AMPL object is still allocated
  */
  bool isValid() const {
    return internal::AMPL_EntityBase_isValid(impl_, internal::ErrorInfo());
  }
