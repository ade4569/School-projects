        ...
        public static int Main(string[] args)
        {
          ...
          "MCH", "MTL", "SPG", "TUR" };
            ...
            { 295,  770, 440, 430,  315, 400,  379,  450 }
                ...
                ampl.Solve();
                // New style accessors
                // Note that these are ok to get/set small quantities of data,
                // but in general refer to AMPL.GetData, AMPL.SetData or Entity.GetValues
                Console.WriteLine(string.Format("Objective: {0}",
                  ampl.Obj["Total_Cost"].Value));
                Console.WriteLine(string.Format("Buy[BEEF]: {0}",
                  ampl.Var["Buy"]["BEEF"].Value));
                Console.WriteLine(string.Format("amt[A,BEEF]: {0}",
                    ampl.Param["amt"]["A", "BEEF"]));
                return 0;
            }
        }
    }
